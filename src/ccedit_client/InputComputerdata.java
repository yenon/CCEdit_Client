 ...
 * @author Basti
 */
public class InputComputerdata extends javax.swing.JFrame {

    /**
     * Creates new form InputComputerdata
     */
    public InputComputerdata() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Uploader u = new Uploader("ls", jTextField1.getText(), "", String.copyValueOf(jPasswordField1.getPassword()), "");
        u.start();
        if (!(u.getResponse().startsWith("Error:") || u.getResponse().startsWith("Exception:"))) {
            try {
                ...
                settings.setProperty("Password",String.copyValueOf(jPasswordField1.getPassword()));
    ...
    public static void main(EditFrame _ef) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new InputComputerdata().setVisible(true);
            }
        });
    }
